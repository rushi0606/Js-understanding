...
console.log(myArr.includes(9));  //it will give boolean answer true or false
...
console.log(Array.isArray("Rushikesh")) //check whether it is array or not and gives output in true or false
